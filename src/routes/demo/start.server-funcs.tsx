...
const getCurrentServerTime = createServerFn({
  ...
  const url = 'https://api.cabinpi.com/api/sensors/latest'

  const res = await fetch(url, {
    method: 'GET',
    headers: {
      'CF-Access-Client-Id':
        'd8856e9e0d8a0b501a1ffad7266a6ad3.access',
      'CF-Access-Client-Secret':
        'c6cd7a72aae0f0f6df2e3e0239649498be2c659118118c55eaca43bbee0b7c40',
    },
  })

  if (!res.ok) {
    throw new Error(`Failed to fetch latest sensors: ${res.status}`)
  }
